 ...
 */
public class ListAdapter_ImagenTexto2 extends BaseAdapter {
    ...
    public ListAdapter_ImagenTexto2(Activity activity, LinkedList<Hashtable<String, String>> aplicaciones, Administrador admin1) {
        this.activity = activity;
        this.datos = aplicaciones;
        this.todos = aplicaciones;
        this.layout_fila= R.layout.row2;
        admin=admin1;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //Descargo la foto
        viewHolder.getImg1().setImageUrl(datos.get(position).get("imagenen_url"), imageLoader);
        viewHolder.getImg1().setErrorImageResId(R.drawable.fondo_verde_1);
        viewHolder.getImg1().setDefaultImageResId(R.drawable.fondo_verde_1);
